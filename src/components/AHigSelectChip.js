...
class MultipleSelectChip extends React.Component {
  state = {
    name: [],
  };
  ...
  render() {
    ...
    return (
      <FormControl fullWidth={true} error="RAWR">
        ...
        <Select
          ...
          MenuProps={MenuProps}
          // IconComponent={<i class="fas fa-caret-down" />}
        >
          {names.map((name) => (
            <MenuItem
              key={name}
...
export default withStyles(styles, {withTheme: true})(MultipleSelectChip);
